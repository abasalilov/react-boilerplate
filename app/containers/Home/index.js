...
import {
  setSearch as createSetSearchAction,
  loadDecoded,
  changeVin,
} from './actions';
...
export function mapDispatchToProps(dispatch) {
  return {
    setSearch: (vin) => dispatch(createSetSearchAction(vin)),
    setVinData: (data) => dispatch(loadDecoded(data)),
    onChangeVin: (data) => dispatch(changeVin(data)),
  };
}
