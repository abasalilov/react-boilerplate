...
describe('PD React Redux GraphQL', function(){
  it('.should() - assert that <title> is correct', function(){
    ...
    cy.title().should('include', 'GraphQL')
    //   ↲               ↲            ↲
  ...
  context('Querying', function(){
    ...
    cy.get('button').should('contain', 'GJM');
    ...
    cy.get('button').click().next().should('contain', 'Part Detail')
